...
Console.Write("Введите имя аватара, которое будет отображаться: ");
string? username = Console.ReadLine();
Console.Write("Введите порт для приема сообщений: ");
Console.Write("------- ");
Console.Write("Если вы не знаете как, выполните следующие действия: ");
Console.Write("1. Откройте командную строку (CMD)");
Console.Write("2. Введите в командной строке: ipconfig ");
Console.Write("3. Затем команду: netstat -a, после чего вы увидите весь список ваших портов.");
